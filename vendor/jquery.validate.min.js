...
( function ( c ) {
        ...
        validate: function ( a ) {
            if ( this.length ) {
                ...
                if ( b.settings.onsubmit ) {
                    ...
                    a.filter( ".cancel" )
                        .click( function ( ) { b.cancelSubmit = true } );
                    b.settings.submitHandler && a.filter( ":submit" )
                        .click( function ( ) { b.submitButton = this } );
                    this.submit( function ( d ) {
                        function e( ) {
                            if ( b.settings.submitHandler ) {
                                if ( b.submitButton ) var f = c( "<input type='hidden'/>" )
                                    .attr( "name"
                                        , b.submitButton.name )
                ...
                return b
            } else a && a.debug && window.console && console.warn( "nada selecionado, não é possível validar, retornando nada" )
        }
        , valid: function ( ) {
            if ( c( this[ 0 ] )
    ...
    c.validator.format = function ( a, b ) {
        ...
        if ( arguments.length > 2 && b.constructor != Array ) b = c.makeArray( arguments )
            .slice( 1 );
    ...
    c.extend( c.validator, {
        defaults: {
            ...
            , onfocusin: function ( a ) {
                ...
                if ( this.settings.focusCleanup && !this.blockFocusCleanup ) {
                    ...
                    this.addWrapper( this.errorsFor( a ) )
                        .hide( )
                }
            }
        ...
        , messages: {
            ...
            , maxlength: c.validator.format( "Digite no máximo {0} caracteres." )
            , minlength: c.validator.format( "Digite pelo menos {0} caracteres." )
            , rangelength: c.validator.format( "Digite um valor entre {0} e {1} caracteres." )
            , range: c.validator.format( "Digite um valor entre {0} e {1}." )
            , max: c.validator.format( "Digite um valor menor ou igual a {0}." )
            , min: c.validator.format( "Digite um valor maior ou igual a {0}." )
        }
        ...
        , prototype: {
            init: function ( ) {
                ...
                c( this.currentForm )
                    .validateDelegate( "[type='text'], [type='password'], [type='file'], select, textarea, [type='number'], [type='search'] ,[type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'] ", "focusin focusout keyup", a )
                    .validateDelegate( "[type='radio'], [type='checkbox'], select, option", "click"
                        , a );
                this.settings.invalidHandler && c( this.currentForm )
            ...
            , resetForm: function ( ) {
                c.fn.resetForm && c( this.currentForm )
                    .resetForm( );
                this.submitted = {};
            ...
            , elements: function ( ) {
                ...
                return c( this.currentForm )
                    ...
                    .filter( function ( ) {
                        ...
                        if ( this.name in b || !a.objectLength( c( this )
                                .rules( ) ) ) return false;
            ...
            , customMetaMessage: function ( a, b ) {
                if ( c.metadata ) {
                    var d = this.settings.meta ? c( a )
                        .metadata( )[ this.settings.meta ] : c( a )
                        .metadata( );
            ...
            , defaultMessage: function ( a
                , b ) { return this.findDefined( this.customMessage( a.name, b ), this.customMetaMessage( a, b ), !this.settings.ignoreTitle && a.title || undefined, c.validator.messages[ b ], "<strong>Aviso: Nenhuma mensagem definida para " + a.name + "</strong>" ) }
            ...
            , showLabel: function ( a, b ) {
                ...
                if ( d.length ) {
                    ...
                    d = c( "<" + this.settings.errorElement + "/>" )
                        ...
                        .addClass( this.settings.errorClass )
                        .html( b || "" );
                    if ( this.settings.wrapper ) d = d.hide( )
                        .show( )
                        .wrap( "<" + this.settings.wrapper + "/>" )
                        .parent( );
                    this.labelContainer.append( d )
                        .length || ( this.settings.errorPlacement ? this.settings.errorPlacement( d, c( a ) ) : d.insertAfter( a ) )
                }
            ...
            , validationTargetFor: function ( a ) {
                if ( this.checkable( a ) ) a = this.findByName( a.name )
            ...
            , findByName: function ( a ) {
                ...
                return c( document.getElementsByName( a ) )
                    .map( function ( d
            ...
            , getLength: function ( a, b ) {
                ...
                case "select":
                    return c( "option:selected", b )
                        .length;
                case "input":
                    if ( this.checkable( b ) ) return this.findByName( b.name )
                        .filter( ":checked" )
                        .length
                }
                return a.length
        ...
        , classRules: function ( a ) {
            var b = {};
            ( a = c( a )
                .attr( "class" ) ) && c.each( a.split( " " ), function ( ) { this in c.validator.classRuleSettings && c.extend( b, c.validator.classRuleSettings[ this ] ) } );
            return b
        }
...
( function ( c ) {
    ...
    if ( c.ajaxPrefilter ) c.ajaxPrefilter( function ( d, e, f ) {
        ...
        var b = c.ajax;
        c.ajax = function ( d ) {
            var e = ( "port" in d ? d : c.ajaxSettings )
                .port;
            if ( ( "mode" in d ? d : c.ajaxSettings )
                .mode == "abort" ) { a[ e ] && a[ e ].abort( ); return a[ e ] = b.apply( this, arguments ) }
